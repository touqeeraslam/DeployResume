        ...
        <div className="row py-5">
            <div className="col-9">
                <div>
                    ...
                    <h1 className="color-07 fw-bold">Experience</h1>
                    <h4 className="font-16 color-07 fw-bold py-2">Here's what you need to know</h4>
                    <div className="fw-light">You can include any work experience, internships, scholarships,</div>
                    <div>relevant coursework and academic achievements.</div>
                </div>
            </div>
        </div>
